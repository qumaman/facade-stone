    ...
    <div class="col-md-3">
        <ul class="list-group sidebar-nav-v1" id="sidebar-nav">
            <li class="list-group-item list-toggle">
                <a data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse-designs" aria-expanded="true">Печати и штампы</a>
                <ul id="collapse-designs" class="collapsed collapse in">
                        <li><a href="/designs/1"> Печати ИП, ТОО, АО</a></li>
                        <li><a href="/designs/2"> Врачебные печати</a></li>
                        <li><a href="/designs/3"> Гербовые печати в соответствии с требованиями СТ РК 1430-2005</a></li>
                        <li><a href="/designs/4"> Печати нотариуса</a>{{--<span class="badge badge-u">New</span>--}}</li>
                        <li><a href="/designs/5"> Штампы</a></li>
                        <li><a href="/designs/6"> Датеры</a></li>
                        <li><a href="/designs/7"> Нумераторы</a></li>
                        <li><a href="/designs/8"> Факсимиле</a></li>
                        <li><a href="/designs/9"> Экслибрис (личная печать)</a></li>
                        <li><a href="/designs/10"> Печати по оттиску и эскизу</a></li>
                        <li><a href="/designs/11"> Клише для печатей и штампов</a></li>
                        <li><a href="/designs/12"> Ликвидация печати</a></li>
                        <li><a href="/designs/13"> Аксессуары</a></li>
                </ul>
            </li>
        </ul>
    </div>
